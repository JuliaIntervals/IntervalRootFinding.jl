...
"""
function bisect(X::Interval, α=bisect_place)
    @assert 0 ≤ α ≤ 1
...
"""
function bisect(X::IntervalBox, α=bisect_place)
...
"""
function bisect(X::IntervalBox, i::Integer, α=bisect_place)
